...
RoutingProtocol::Start ()
{
  ...
  m_periodicUpdateTimer.SetFunction (&RoutingProtocol::SendPeriodicUpdate,this);   // elly 
...
RoutingProtocol::RouteInput (Ptr<const Packet> p,
  ...
  std::cout << "........................................"<<std::endl;
  std::cout << m_mainAddress << " received packet" <<p->GetUid () <<"to destination " << header.GetDestination () << std::endl;
...
RoutingProtocol::SendPeriodicUpdate ()
{
  ...
  ///////////////////Elly/////////////////////////////////////////
  pupdate_cnt++;  //how many periodic updates are occured
  ////////////////////////////////////////////////////////////
  if (allRoutes.empty ())
    {
      return;
...
/////////////////////////////Elly////////////////////////////////////////////
 ...
 if ( pupdate_cnt != 2 )
    { 
	  ...
	  std::cout << " ________________________________5Cut__________"<<std::endl;
        ...
        { 
          ...
          std::cout << " This is pupdate_cnt:" << pupdate_cnt <<std::endl;
          std::cout << " This is data_cnt:" << data_cnt <<std::endl;  
          std::cout << "___________________________________5Cut_________"<<std::endl;
  ...
  else if (pupdate_cnt == 2)
    {
	  ...
	  std::cout << " pupdate == 2,data<3 m_periodicInterval" << m_periodicUpdateInterval <<std::endl;
          std::cout << " This is pupdate_cnt:" << pupdate_cnt <<std::endl;
          std::cout << " This is data_cnt:" << data_cnt <<std::endl;
          std::cout << " _________________________________10Cut_________"<<std::endl;
       ...
       else
        {
          ...
          std::cout << " This is pupdate_cnt:" << pupdate_cnt <<std::endl;
          std::cout << " This is data_cnt:" << data_cnt <<std::endl;
          std::cout << " _________________________________10Cut_______"<<std::endl;        
